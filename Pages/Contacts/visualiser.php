...
$sql= "select * from Contacts"; $curseur = mysqli_query($bdd,$sql);
echo ("<H2>Visualiser mes contacts!</H2>"); 
    while ($row = mysqli_fetch_assoc($curseur)){
        $guestid = $row["idcontact"]; echo "<b>ID :</b> $guestid<br />";
        ...
        $commentaires = $row["commentaires"]; echo "<b>Commentaires :</b> $commentaires<br /><br />";
