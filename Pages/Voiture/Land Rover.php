...
$requete = $bdd->query("SELECT * FROM voiture WHERE marque LIKE '%Land Rover%'");
...
<head>
    ...
    <title>Modèles de Land Rover</title>
</head>
<body>
<style>
.vid {
    ...
    align-items: center;
    background-image: url('../../assets/images/illustration-LandRover.jpg');
...
<div class="vid">
    <div class="vid1">
        <center><h1 class="titre">LAND ROVER</h1></center>
        <div class="descri">
        Repoussez les limites du possible.
            Découvrez l’élégance robuste et l’ingéniosité britannique signées Land Rover.
            Dominez tous les terrains avec confort, style et maîtrise.
            Choisissez l’aventure raffinée, choisissez Land Rover.
        </div>
    </div>
</div>
...
<center>
    <div class="css">
        <h1>Découvrez nos modèles avec Land Rover</h1>
        <img src="../../assets/images/LogoLand-Rover.png" style="width: 200px; height: auto;">
    </div>
</center>
