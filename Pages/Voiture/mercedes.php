...
$requete = $bdd->query("SELECT id_voiture, marque, modele, prix, motorisation, puissance, transmission, image_illustration, img_illustr1, img_illustr2, img_illustr3 FROM voiture WHERE marque = 'Mercedes'");
