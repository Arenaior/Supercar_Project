...
$requete = $bdd->query("SELECT * FROM voiture WHERE marque LIKE '%Renault%'");
...
<div class="vid">
    <div class="vid1">
        <center><h1 class="titre">RENAULT</h1></center>
        <div class="descri">
            Renault allie innovation et élégance pour rendre chaque trajet unique. 
            Avec des véhicules conçus pour le confort et la sécurité, elle accompagne 
            vos aventures au quotidien. Roulez avec confiance, style et performance.
        </div>
    </div>
</div>
...
<center>
    <div class="css">
        <h1>Découvrez nos modèles Renault</h1>
        <img src="../../assets/images/Renault-logo.png" style="width: 150px; height: auto;">
    </div>
</center>
